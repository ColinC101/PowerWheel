/*
  PidReportDescriptor.h - USB-PID report descriptor for force feedback devices
  Copyright (C) 2020 Colin Constans
  Copyright (C) 2019  Hoan Tran (tranvanhoan206 [at] gmail [dot] com)
  Copyright (C) 2016  Jaka Simonic (telesimke [at] gmail [dot] com)
  Copyright (C) 2012  Tero Loimuneva (tloimu [at] gmail [dot] com)
...
#ifndef PIDREPORTDESCRIPTOR_H
#define PIDREPORTDESCRIPTOR_H

#define PID_REPORT_DESCRIPTOR_SIZE 1201
